...
<head>
   <meta charset="UTF-8">
   <title>ProAlto Company - Design</title>
   ...
   <link rel="icon" href="../images/ProAltoCompany.ico">
</head>
<body>
   <div id="interface-mensagem_envia">
      <?php
         ...
         $subject = "$assunto";
         $to = new SendGrid\Email(null, "jv.oliveraraujo@gmail.com"); 
      ...
      <div id="mensagem" class="container-fluid text-center">
         ...
         <a href="../index.html" class="btn btn-primary"><span class="fa fa-arrow-left"></span> Voltar para o site</a>
      </div>
   </div> 
</body>
</html>